...
import table from "./column.config";
...
const ColumnTable = () => {
  ...
  const stateDev = useSelector((state) => state?.Table?.data["column"]);
  const columnTable = useTable("column", table);
  ...
  return (
    <div direction="column" className="table-container">
      <div className="header-container">
        <div className="title">4-Column Table</div>
        <div>
          <Dropdown
            label=""
            dismissOnClick={true}
